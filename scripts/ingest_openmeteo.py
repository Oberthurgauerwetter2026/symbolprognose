...
def build_grid():
    min_lat = envf("BBOX_MIN_LAT", 47.025)
    max_lat = envf("BBOX_MAX_LAT", 48.125)
    min_lon = envf("BBOX_MIN_LON", 8.35)
    max_lon = envf("BBOX_MAX_LON", 10.35)
    n_lat = envi("GRID_LAT", 24)
    n_lon = envi("GRID_LON", 40)
